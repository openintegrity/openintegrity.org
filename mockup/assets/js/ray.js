...
var _user$project$Types$norms = function (line) {
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$cos(line.vector.angle),
		_1: _elm_lang$core$Basics$sin(line.vector.angle)
	};
};
var _user$project$Types$vectorBetween = F2(
	function (p1, p2) {
		var dy = p2.y - p1.y;
		var dx = p2.x - p1.x;
		return {
			length: _elm_lang$core$Basics$sqrt((dx * dx) + (dy * dy)),
			angle: A2(_elm_lang$core$Basics$atan2, p2.y - p1.y, p2.x - p1.x)
		};
	});
var _user$project$Types$lineBetween = F2(
	function (from, to) {
		return {
			position: from,
			vector: A2(_user$project$Types$vectorBetween, from, to)
		};
	});
var _user$project$Types$adjustAngle = F2(
	function (delta, line) {
		var vector = line.vector;
		return _elm_lang$core$Native_Utils.update(
			line,
			{
				vector: _elm_lang$core$Native_Utils.update(
					vector,
					{angle: vector.angle + delta})
			});
	});
var _user$project$Types$withLength = F2(
...
var _user$project$Types$toXY = function (p) {
	return {ctor: '_Tuple2', _0: p.x, _1: p.y};
};
var _user$project$Types$end = function (line) {
...
var _user$project$Types$start = function (line) {
	return line.position;
};
var _user$project$Types$intersect = F2(
	function (r, s) {
		var _p1 = _user$project$Types$norms(s);
		var s_dx = _p1._0;
		var s_dy = _p1._1;
		var _p2 = _user$project$Types$norms(r);
		var r_dx = _p2._0;
		var r_dy = _p2._1;
		var _p3 = _user$project$Types$toXY(
			_user$project$Types$start(s));
		var s_px = _p3._0;
		var s_py = _p3._1;
		var _p4 = _user$project$Types$toXY(
			_user$project$Types$start(r));
		var r_px = _p4._0;
		var r_py = _p4._1;
		var sm = ((((r_px * r_dy) - (r_py * r_dx)) + (s_py * r_dx)) - (s_px * r_dy)) / ((s_dx * r_dy) - (s_dy * r_dx));
		var rm = ((s_px - r_px) + (s_dx * sm)) / r_dx;
		return (_elm_lang$core$Basics$isNaN(sm) || _elm_lang$core$Basics$isNaN(rm)) ? _elm_lang$core$Maybe$Nothing : ((_elm_lang$core$Native_Utils.cmp(sm, 0) < 0) ? _elm_lang$core$Maybe$Nothing : ((_elm_lang$core$Native_Utils.cmp(s.vector.length, sm) < 0) ? _elm_lang$core$Maybe$Nothing : ((_elm_lang$core$Native_Utils.cmp(rm, 0) < 0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
			A2(_user$project$Types$withLength, rm, r)))));
	});
var _user$project$Types$curtail = F2(
	function (walls, line) {
		return _elm_lang$core$List$head(
			A2(
				...
				A2(
					...
					_user$project$Types$intersect(line),
					walls)));
	});
var _user$project$Types$toRays = F2(
	function (position, line) {
		var rayToEnd = A2(
			_user$project$Types$lineBetween,
			position,
			_user$project$Types$end(line));
		var rayToStart = A2(
			_user$project$Types$lineBetween,
			position,
			_user$project$Types$start(line));
		return _elm_lang$core$Native_List.fromArray(
			[
				A2(
				_user$project$Types$adjustAngle,
				_elm_lang$core$Basics$degrees(0.5),
				rayToStart),
				A2(
				_user$project$Types$adjustAngle,
				_elm_lang$core$Basics$degrees(-0.5),
...
var _user$project$Types$solveRays = F2(
	function (walls, rayStart) {
		return A2(
			_elm_lang$core$List$filterMap,
			_user$project$Types$curtail(walls),
			A2(
				_elm_lang$core$List$concatMap,
				_user$project$Types$toRays(rayStart),
				walls));
	});
var _user$project$Types$Line = F2(
	function (a, b) {
		return {position: a, vector: b};
	});
var _user$project$Types$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Types$Vector = F2(
	function (a, b) {
		return {length: a, angle: b};
	});
var _user$project$Types$Model = F3(
	function (a, b, c) {
		return {walls: a, mouse: b, size: c};
	});
...
var _user$project$Types$Mouse = function (a) {
	return {ctor: 'Mouse', _0: a};
};
var _user$project$State$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$mouse$Mouse$moves(_user$project$Types$Mouse),
			...
			case 'Mouse':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mouse: _elm_lang$core$Maybe$Just(_p1._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$State$initialState = {
	...
	_0: {
		walls: _elm_lang$core$Native_List.fromArray(
			[
				...
				vector: {
					length: 600,
					angle: _elm_lang$core$Basics$degrees(0)
				}
			},
				{
				position: {x: 300, y: -300},
				vector: {
					length: 600,
					angle: _elm_lang$core$Basics$degrees(90)
				}
			},
				{
				position: {x: -300, y: -300},
				...
				vector: {
					length: 600,
					angle: _elm_lang$core$Basics$degrees(180)
				}
			},
				{
				...
				vector: {
					length: 50,
					angle: _elm_lang$core$Basics$degrees(315)
				}
			},
				{
				position: {x: -80, y: 100},
				vector: {
					length: 50,
					angle: _elm_lang$core$Basics$degrees(290)
				}
			},
				{
				...
				vector: {
					length: 150,
					angle: _elm_lang$core$Basics$degrees(250)
				}
			},
				{
				...
				vector: {
					length: 120,
					angle: _elm_lang$core$Basics$degrees(235)
				}
			},
				{
				...
				vector: {
					length: 300,
					angle: _elm_lang$core$Basics$degrees(70)
				}
			},
				{
				position: {x: 0, y: -150},
				vector: {
					length: 300,
					angle: _elm_lang$core$Basics$degrees(30)
				}
			}
			]),
	...
	_1: A3(_elm_lang$core$Task$perform, _user$project$Types$Error, _user$project$Types$Resize, _elm_lang$window$Window$size)
};
var _user$project$View$wallLineStyle = _elm_lang$core$Native_Utils.update(
	_evancz$elm_graphics$Collage$defaultLine,
	{width: 8, cap: _evancz$elm_graphics$Collage$Round});
var _user$project$View$rayColor = _elm_lang$core$Color$lightYellow;
var _user$project$View$drawTriangles = F2(
	function (color, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._1;
		var _p2 = _p1._0;
		return A2(
			...
			_evancz$elm_graphics$Collage$polygon(
				A2(
					_elm_lang$core$List$map,
					_user$project$Types$toXY,
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Types$start(_p2),
							_user$project$Types$end(_p2),
							_user$project$Types$end(_p3),
							_user$project$Types$start(_p3)
						]))));
	});
var _user$project$View$drawLine = F2(
	function (lineStyle, line) {
		var lineEnd = _user$project$Types$toXY(
			_user$project$Types$end(line));
		var lineStart = _user$project$Types$toXY(
			_user$project$Types$start(line));
		return A2(
			_evancz$elm_graphics$Collage$traced,
			lineStyle,
			A2(_evancz$elm_graphics$Collage$segment, lineStart, lineEnd));
	});
var _user$project$View$element = F3(
	function (walls, _p5, _p4) {
		var _p6 = _p5;
		var _p10 = _p6._0;
		var _p9 = _p6._1;
		var _p7 = _p4;
		var rayPosition = {
			x: _p7._0 - (_elm_lang$core$Basics$toFloat(_p10) / 2.0),
			y: (_elm_lang$core$Basics$toFloat(_p9) / 2.0) - _p7._1
		};
		return A2(
			_evancz$elm_graphics$Element$flow,
				...
				[
						...
						[
							...
							function () {
								var solutions = A2(
									...
									A2(_user$project$Types$solveRays, walls, rayPosition));
								var cycled = A2(
									_elm_lang$core$Basics_ops['++'],
									solutions,
									A2(_elm_lang$core$List$take, 1, solutions));
								return A2(
									_elm_lang$core$List$map,
									_user$project$View$drawTriangles(_user$project$View$rayColor),
									A3(
										_elm_lang$core$List$map2,
										F2(
											function (v0, v1) {
										...
										A2(
											...
											_elm_lang$core$Native_List.fromArray(
												[]),
											_elm_lang$core$List$tail(cycled))));
							}()),
							A2(
							_evancz$elm_graphics$Collage$move,
							_user$project$Types$toXY(rayPosition),
							A2(
								_evancz$elm_graphics$Collage$filled,
							...
							A2(
								_elm_lang$core$List$map,
								_user$project$View$drawLine(_user$project$View$wallLineStyle),
								walls))
						])),
					A4(
					...
					_evancz$elm_graphics$Element$centered(
						_evancz$elm_graphics$Text$concat(
							_elm_lang$core$Native_List.fromArray(
								[
									_evancz$elm_graphics$Text$fromString('A raycasting hack in '),
									A2(
									_evancz$elm_graphics$Text$link,
									'http://elm-lang.org/',
									_evancz$elm_graphics$Text$fromString('Elm')),
									_evancz$elm_graphics$Text$fromString(', based on '),
									A2(
									_evancz$elm_graphics$Text$link,
									'http://ncase.me/sight-and-light',
									_evancz$elm_graphics$Text$fromString('this excellent tutorial')),
									_evancz$elm_graphics$Text$fromString('.')
								])))),
					A4(
					_evancz$elm_graphics$Element$container,
					...
					_evancz$elm_graphics$Element$centered(
						A2(
							...
							_evancz$elm_graphics$Text$fromString('Source Code'))))
				]));
	});
var _user$project$View$root = function (model) {
	var _p11 = {ctor: '_Tuple2', _0: model.size, _1: model.mouse};
	if (((_p11.ctor === '_Tuple2') && (_p11._0.ctor === 'Just')) && (_p11._1.ctor === 'Just')) {
		var _p13 = _p11._0._0;
		var _p12 = _p11._1._0;
		return _evancz$elm_graphics$Element$toHtml(
			A3(
				_user$project$View$element,
				model.walls,
				{ctor: '_Tuple2', _0: _p13.width, _1: _p13.height},
				{
					ctor: '_Tuple2',
					_0: _elm_lang$core$Basics$toFloat(_p12.x),
					_1: _elm_lang$core$Basics$toFloat(_p12.y)
				}));
	} else {
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$State$initialState, subscriptions: _user$project$State$subscriptions, update: _user$project$State$update, view: _user$project$View$root})
};
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
